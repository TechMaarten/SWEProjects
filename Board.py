...
class Board:
    ...
    def add_checker(self, checker, col):
        ...
        self.slots[count][col] = checker


    
    ### add your reset method here ###
    def reset(self):
        """ method that should reset the Board object on which it is called by 
    ...
    def can_add_to(self, col):
        """ method  that returns True if it is valid to place a checker in the column 
    ...
    def is_full(self):
        """ method  that returns True if the called Board object is completely full of 
    ...
    def remove_checker(self, col):
        """ method that removes the top checker from column col of the called Board
    ...
    def is_win_for(self, checker): 
        """ method  that accepts a parameter checker that is either 'X' or 'O', and 
        returns True if there are four consecutive slots containing checker on the 
